...
class GameDrawningPage extends React.Component {
  ...
  componentDidMount(){
    setTimeout(()=>{
        ...
        this.saveableCanvas1.loadSaveData(this.state.artList[0], true)
        this.saveableCanvas2.loadSaveData(this.state.artList[1], true)
        this.saveableCanvas3.loadSaveData(this.state.artList[2], true)
    }, 100);
  }
