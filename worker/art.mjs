...
// * rooms: A Durable Object namespace binding mapped to the ArtRoom class.
...
const settings = {
  maxMessageSize: 200000, // Sadly dataUrl images are massive :()
}
...
// =======================================================================================
// The ArtRoom Durable Object Class

// ArtRoom implements a Durable Object that coordinates an individual chat room. Participants
// connect to the room using WebSockets, and the room broadcasts messages from each participant
// to all others.
export class ArtRoom {
  ...
  async handleSession(webSocket, ip) {
    ...
    webSocket.addEventListener("message", async msg => {
      try {
        ...
        if (data.message.length > settings.maxMessageSize) {
...
// messages.
//
// We utilize this in ArtRoom, above, to apply a per-IP-address rate limit. These limits are
